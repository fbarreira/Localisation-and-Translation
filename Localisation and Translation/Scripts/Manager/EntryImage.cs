...
namespace LocalisationAndTranslation
{
	...
	public class EntryImage
	{
		...
		[SerializeField]
		public List<LocalisationImage> Localisations;
		...
		{
			LocalisationImage localisation = new LocalisationImage ();
		...
		/// <summary> Gets localised sprite of a given language. </summary>
		/// <returns>The string.</returns>
		/// <param name="language">Language.</param>
		public Sprite GetLocalisation (string language)
		{
			int i = FindLocalisation (language);

			return Localisations[i].sprite;
		}
